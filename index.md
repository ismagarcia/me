...
![Octocat](assets/img/gemm_kernel_heuristics.png){:width="192px"} CPUs & GPUs require kernels implementations of GEMM (General Matrix Multiply) and convolution for important AI use-cases; choosing the right implementation in microseconds is crucial through fast and general heuristics.
