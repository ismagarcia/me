...
<pre>
I'm a staff engineer in <a href="https://www.arm.com/">Arm</a>'s Machine Learning Group with <a href="https://www.linkedin.com/in/ianbratt" title="Ian Bratt">Ian Bratt</a> 
and David Mansell.
...
Group, in the Intelligent Machines Future System Designs team,
working with <a href="https://uk.linkedin.com/in/paulshughes">Paul Hughes</a> analysing and prototyping computer vision 
and ML subsystems for ADAS.

In 2012 I joined <a href="https://www.arm.com/">Arm</a>'s Processor Division working in system architecture 
and heterogeneous computing with <a href="https://uk.linkedin.com/in/charles-garc%C3%ADa-tobin-0374071">Charles Garcia-Tobin</a> 
...
In 2007 I started my Phd. in Computer Graphics joining the <a href="http://ggg.udg.edu/">GGG</a>
research group, under the supervision of <a href="http://ima.udg.edu/~dagush/">Dr. Gustavo Patow</a>.
...
<a href="https://community.arm.com/processors/b/blog/posts/exploring-how-cache-coherency-accelerates-heterogeneous-compute">Heterogeneous compute and cache coherency</a>
...
![Octocat](assets/img/phd_thesis_2012_caption.png){:width="128px"}
Ismael Garcia 
PhD Thesis, October 2012

#### Interactive Applications for Sketch-Based Editable Polycube Map
![Octocat](assets/img/editablepc_tvc2013_teaser.png){:width="128px"}
...
![Octocat](assets/img/hash_cache_teaser.png){:width="128px"}
...
![Octocat](assets/img/cohash_2011.png){:width="128px"}
...
![Octocat](assets/img/epcm_i3d_200w_148h.png){:width="128px"}
...
![Octocat](assets/img/Teaser_200w_128h.png){:width="128px"}
...
![Octocat](assets/img/nph07.png){:width="128px"}
...
![Octocat](assets/img/cork_close_view_polygonal_left_121_billboards_multilayer_right_200w_128h.png){:width="128px"}
...
![Octocat](assets/img/billboardIndirectTexturing_200w_128h.png){:width="128px"}
...
![Octocat](assets/img/billboardComparison_200w_128h.png){:width="128px"}
Ismael Garcia, Mateu Sbert, Laszlo Szirmay-Kalos.
...
Technical Computer Engineering for Management (University  of Girona)
Teaching assistant
...
<!--  Improving ML with Data Science --> 
...
Deep Neural Networks on  Cortex-A  Analysis of CPU Inference on Vision workloads  
MEng Electrical & Electronic Engineering Hons Project, Heriot-Watt University

#### 2016    Jan-Peter Larsson 
3D Reconstruction using Stereo Matching Techniques on Scalable Vector Processors
MEng Electrical Hons Project, Edinburgh University 
 
#### 2011	Enrique Nuzete
Interactive polycubemap editor
BEng Project, Technical Computer Engineering for Management
...
Student Research Project, University of Girona
...
#### Siggraph Asia: 
2014 https://sa2014.siggraph.org/en
2015 https://sa2015.siggraph.org/en 
...
#### EG Eurographics:
2008 https://www.ics.forth.gr/eg2008/home.php
2013 http://eg2013.udg.edu
